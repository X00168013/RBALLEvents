...
namespace RBALLEvents.Data
{
    ...
    {
        public static void Initialize(RacquetballContext context)
        {
            ...
            {
                new EventAssignment {
                    EventID = events.Single(c => c.EventName == "Tralee Open" ).RacquetballEventID,
                    EventCoordinatorID = eventcordinators.Single(i => i.LastName == "Morgan").ID
                    },
                new EventAssignment {
                    EventID = events.Single(c => c.EventName == "Moycullen Open" ).RacquetballEventID,
                    EventCoordinatorID = eventcordinators.Single(i => i.LastName == "McCabe").ID
                    },
                new EventAssignment {
                    EventID = events.Single(c => c.EventName == "Autumn League" ).RacquetballEventID,
                    EventCoordinatorID = eventcordinators.Single(i => i.LastName == "Hendrix").ID
                    },
                new EventAssignment {
                    EventID = events.Single(c => c.EventName == "Fermoy Racquetball Club AGM" ).RacquetballEventID,
                    EventCoordinatorID = eventcordinators.Single(i => i.LastName == "Dean").ID
                    },
            ...
            var registrations = new Registration[]
            {
                ...
                new Registration
                {
                    MemberID = members.Single(s => s.LastName == "Shelley").ID, EventID = events.Single(c => c.EventName == "Tralee Open" ).RacquetballEventID, Division=Division.Novice
                },
                new Registration
                {
                    MemberID = members.Single(s => s.LastName == "Shelley").ID, EventID = events.Single(c => c.EventName == "Moycullen Open" ).RacquetballEventID, Division=Division.Novice
                },
                new Registration
                {
                    MemberID = members.Single(s => s.LastName == "Shelley").ID, EventID = events.Single(c => c.EventName == "Fermoy Racquetball Club AGM" ).RacquetballEventID, Division=Division.Novice
                },
                new Registration
                {
                    MemberID = members.Single(s => s.LastName == "Lee").ID, EventID = events.Single(c => c.EventName == "Tralee Open" ).RacquetballEventID, Division=Division.Novice
                },
                new Registration
                {
                    MemberID = members.Single(s => s.LastName == "Frost").ID, EventID = events.Single(c => c.EventName == "Tralee Open" ).RacquetballEventID, Division=Division.Open
                },
                new Registration
                {
                    MemberID = members.Single(s => s.LastName == "Tolstoy").ID, EventID = events.Single(c => c.EventName == "Fermoy Racquetball Club AGM" ).RacquetballEventID,
                },
                new Registration
                {
                    MemberID = members.Single(s => s.LastName == "Dickinson").ID, EventID = events.Single(c => c.EventName == "Autumn League" ).RacquetballEventID, Division=Division.C
                },
                new Registration {
                    MemberID = members.Single(s => s.LastName == "Dickinson").ID,EventID = events.Single(c => c.EventName == "Fermoy Racquetball Club AGM" ).RacquetballEventID

                },
                new Registration
                {
                    MemberID = members.Single(s => s.LastName == "Atwood").ID, EventID = events.Single(c => c.EventName == "Autumn League" ).RacquetballEventID, Division=Division.B
                },
                new Registration
                {
                    MemberID = members.Single(s => s.LastName == "Wilde").ID, EventID = events.Single(c => c.EventName == "Autumn League" ).RacquetballEventID, Division=Division.D
                },
