...
namespace RBALLEvents.Controllers
{
    public class ClubsController : Controller
    {
        ...
        public ClubsController(RacquetballContext context)
        {
            _context = context;
        }
        //GET: Search Clubs
        ...
        /*[HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClubID,Name,County,Province,NumberofCourts,EventCoordinatorID,RowVersion")] Club club)
        {
            if (id != club.ClubID)
            {
                return NotFound();
            ...
            ViewData["EventCoordinatorID"] = new SelectList(_context.EventCoordinators, "ID", "Address", club.EventCoordinatorID);
            return View(club);
        }*/
